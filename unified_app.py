        ...
        if ret and frame is not None and frame.size > 0:
            ...
            if now - self._last_ui_update >= 0.10:
                ...
                if gaze.face_detected:
                    ...
                    self.lbl_ear_quick.configure(text="👁️ Ochi: --", fg="#94a3b8")
                    self.val_ear.configure(text="Nedetectat", fg="#94a3b8")
                    self.val_perclos.configure(text="--", fg="#94a3b8")
                    self.val_pupil.configure(text="--", fg="#94a3b8")
                    self.val_cog.configure(text="--", fg="#94a3b8")
                    self.val_reading.configure(text="--", fg="#94a3b8")
                    self.val_lux.configure(text="--", fg="#94a3b8")
                    self.val_yaw_pitch.configure(text="Yaw: 0.0° | Pitch: 0.0°", fg="#94a3b8")
                    self.val_vor.configure(text="Yaw: 0.0° | Pitch: 0.0°", fg="#94a3b8")
                    self.val_dist.configure(text="--", fg="#94a3b8")
                    self.val_posture.configure(text="Utilizator Absent", fg="#94a3b8")
                    self.val_expr.configure(text="ABSENT", fg="#94a3b8")
